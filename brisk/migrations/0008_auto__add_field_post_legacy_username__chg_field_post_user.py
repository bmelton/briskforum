...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.legacy_username'
        db.add_column(u'forum_post', 'legacy_username',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Post.user'
        db.alter_column(u'forum_post', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):
        # Deleting field 'Post.legacy_username'
        db.delete_column(u'forum_post', 'legacy_username')


        # Changing field 'Post.user'
        db.alter_column(u'forum_post', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']))
