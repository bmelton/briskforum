...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'forum_post', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Topic.name'
        db.alter_column(u'forum_topic', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting field 'Post.name'
        db.delete_column(u'forum_post', 'name')


        # Changing field 'Topic.name'
        db.alter_column(u'forum_topic', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
