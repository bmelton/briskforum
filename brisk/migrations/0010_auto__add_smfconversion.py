...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SMFConversion'
        db.create_table(u'forum_smfconversion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('forum', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('has_begun', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('begun', self.gf('django.db.models.fields.DateTimeField')()),
            ('has_finished', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('time_taken_readable', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'forum', ['SMFConversion'])


    def backwards(self, orm):
        # Deleting model 'SMFConversion'
        db.delete_table(u'forum_smfconversion')
    ...
    models = {
        ...
        u'forum.smfconversion': {
            ...
            'begun': ('django.db.models.fields.DateTimeField', [], {}),
            ...
            'time_taken_readable': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        u'forum.topic': {
