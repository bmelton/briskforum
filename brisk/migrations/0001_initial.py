...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'forum_category', (
            ...
            ('old_category_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
        ...
        m2m_table_name = db.shorten_name(u'forum_category_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('category', models.ForeignKey(orm[u'forum.category'], null=False)),
        ...
        db.create_table(u'forum_forum', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('old_forum_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ...
            ('post_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True)),
            ('topic_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True)),
        ...
        m2m_table_name = db.shorten_name(u'forum_forum_moderators')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
        ...
        db.create_table(u'forum_topic', (
            ...
            ('old_topic_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ...
            ('active', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('post_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True)),
            ('last_post', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='last_topic_post', null=True, to=orm['forum.Post'])),
        ))
        ...
        db.create_table(u'forum_post', (
            ...
            ('old_post_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'forum_category_groups'))

        # Deleting model 'Forum'
        db.delete_table(u'forum_forum')

        # Removing M2M table for field moderators on 'Forum'
        db.delete_table(db.shorten_name(u'forum_forum_moderators'))
