...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SMFConversion.time_taken'
        db.delete_column(u'forum_smfconversion', 'time_taken')

        # Deleting field 'SMFConversion.time_taken_readable'
        db.delete_column(u'forum_smfconversion', 'time_taken_readable')


    def backwards(self, orm):
        # Adding field 'SMFConversion.time_taken'
        db.add_column(u'forum_smfconversion', 'time_taken',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SMFConversion.time_taken_readable'
        db.add_column(u'forum_smfconversion', 'time_taken_readable',
