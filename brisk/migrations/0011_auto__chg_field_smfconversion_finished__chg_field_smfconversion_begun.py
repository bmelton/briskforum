...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SMFConversion.finished'
        db.alter_column(u'forum_smfconversion', 'finished', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'SMFConversion.begun'
        db.alter_column(u'forum_smfconversion', 'begun', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'SMFConversion.finished'
        db.alter_column(u'forum_smfconversion', 'finished', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'SMFConversion.begun'
        db.alter_column(u'forum_smfconversion', 'begun', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 2, 24, 0, 0)))
