...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SMFConversion.time_taken'
        db.alter_column(u'forum_smfconversion', 'time_taken', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'SMFConversion.time_taken'
        db.alter_column(u'forum_smfconversion', 'time_taken', self.gf('django.db.models.fields.PositiveIntegerField')(default=datetime.datetime(2014, 2, 24, 0, 0)))
