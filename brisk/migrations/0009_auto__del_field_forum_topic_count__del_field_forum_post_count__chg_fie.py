...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'forum_forum', 'topic_count')

        # Deleting field 'Forum.post_count'
        db.delete_column(u'forum_forum', 'post_count')


        # Changing field 'Post.created'
        db.alter_column(u'forum_post', 'created', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Adding field 'Forum.topic_count'
        db.add_column(u'forum_forum', 'topic_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Forum.post_count'
        db.add_column(u'forum_forum', 'post_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)


        # Changing field 'Post.created'
        db.alter_column(u'forum_post', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 2, 24, 0, 0)))
